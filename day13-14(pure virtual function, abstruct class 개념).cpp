...
//  : 선언부만 있고 정의부가 없는 virtual function (= 가상함수)
//     -> 쉽게 말해, virtual 함수에 내용이 없으면, 그게 순수가상함수
//         -> (목적!) 자식 class에서 override된 함수에 부모 class 객체포인터가 접근 및 호출하기 위한 목적으로 정의되는 함수 
...
// quiz3 : quiz2의 각각의 동물 울음소리와 걸음을 animal을 선조로 해서 override해서 표현하는걸 추상클래스를 사용해서 해결해라
#include <iostream>
#include <iomanip>
